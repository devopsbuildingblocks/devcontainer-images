...
|-------|-------------|-----------------|
| `ubuntu-base` | Foundation image with build dependencies | 0.1.11 |
| `ubuntu-devbox` | Adds Nix and Devbox package management | 0.1.13 |
| `ubuntu-toolbox` | Adds modern CLI tools | 0.1.5 |
| `ubuntu-toolbox-nf` | Toolbox with Nerd Font icons enabled | 0.1.5 |

### Rocky Linux-based Images

| Image | Description | Current Version |
|-------|-------------|-----------------|
| `rocky-base` | Foundation image based on Rocky Linux 9 | 0.1.4 |
| `rocky-devbox` | Adds Nix and Devbox package management | 0.1.4 |
| `rocky-toolbox` | Adds modern CLI tools | 0.1.4 |
| `rocky-toolbox-nf` | Toolbox with Nerd Font icons enabled | 0.1.4 |
...
```json
{
  "image": "ghcr.io/devopsbuildingblocks/devcontainer-images/ubuntu-toolbox:0.1.5"
}
```
